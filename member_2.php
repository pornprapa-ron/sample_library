    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                ...
                <h5 class="mt-3">Member Version 2</h5>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="row">
                    ...
                    <div class="col text-end">
                        <a href="member_create_callback.php" class="btn btn-primary mb-3"><i class="fa-solid fa-plus"></i> Add Member</a>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="member_edit.php?id=<?= $row['member_id'] ?>" class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                                    <a href="member_delete.php?id=<?= $row['member_id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this member?');"><i class="fa-solid fa-trash"></i> Delete</a>
                                </td>
                            </tr>
                        <?php
                        }
